...
const part_one = () => console.log('What BOOST keycode does it produce?', solve(1))
const part_two = () => console.log('What are the coordinates of the distress signal?', solve(2))
